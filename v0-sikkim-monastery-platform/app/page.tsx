      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <PanoramaViewer
            ...
            narration={{
              en: "Welcome to Rumtek Monastery, the seat of the Karmapa. Explore the prayer hall, the golden stupa, and the serene courtyards.",
              hi: "रूमटेक मठ में आपका स्वागत है। प्रार्थना हाल, स्वर्ण स्तूप और शांत आंगनों का अन्वेषण करें।",
              ne: "रुमटेक गोम्पामा स्वागत छ। प्रार्थना हल, सुनौलो स्तूप र शान्त आँगनहरू अन्वेषण गर्नुहोस्।"
            }}
            location={{ lat: 27.33194, lng: 88.60194 }}
