...
import { MapPin, Navigation, Info, X, Camera, Maximize2, Minimize2, ExternalLink } from 'lucide-react'
...
export default function InteractiveMap({ onMonasterySelect }: InteractiveMapProps) {
  ...
  const handleOpenInGoogleMaps = (monastery: Monastery) => {
    // Open the monastery location in Google Maps
    const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=${monastery.latitude},${monastery.longitude}`
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2 ml-4">
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => handleOpenInGoogleMaps(selectedMonastery)}
                  ...
                  <div className="p-3 min-w-[200px]">
                    ...
                    <div className="flex gap-1">
                      <Button
                        ...
                        onClick={() => handleOpenInGoogleMaps(monastery)}
                      >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        onClick={e => {
                          e.stopPropagation()
                          handleOpenInGoogleMaps(monastery)
                        }}
                      >
                        <ExternalLink className="w-3 h-3 mr-1" />
                        Google Maps
